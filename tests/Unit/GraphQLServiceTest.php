...
class GraphQLServiceTest extends TestCase
{
    ...
    public function assembleApiUrlDataProvider(): array
    {
        return [
            ...
            [Globals::OAUTH_SCOPE_ADMIN, 'https://example.com', 0, 'https://example.com/graphql/0/admin'],
            [Globals::OAUTH_SCOPE_ADMIN, 'https://example.com', 1, 'https://example.com/graphql/1/admin'],
            [Globals::OAUTH_SCOPE_ADMIN, 'https://example.com', 2, 'https://example.com/graphql/2/admin'],
            [Globals::OAUTH_SCOPE_ADMIN, 'https://example.com/', 3, 'https://example.com//graphql/3/admin'],
        ];
    }
